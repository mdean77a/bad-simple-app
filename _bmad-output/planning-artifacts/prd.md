...
- FR35: Coordinator can export the completed ICF as a PDF document (derived from Markdown via xhtml2pdf, a pure Python library — weasyprint was rejected due to system C library dependencies incompatible with deployment targets)
- FR36: Coordinator can export the completed ICF as a Markdown file (primary export format, assembled programmatically from LLM-generated section content)
- FR37: Coordinator can export the completed ICF as a DOCX (Word) file (derived from Markdown via python-docx)
